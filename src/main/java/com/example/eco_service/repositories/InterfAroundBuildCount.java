...
@Repository
public interface InterfAroundBuildCount extends JpaRepository<AroundBuildCount, Long>, JpaSpecificationExecutor<AroundBuildCount>, RevisionRepository<AroundBuildCount, Long, Integer> {
